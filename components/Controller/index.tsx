...
const Input = (props: InputProps) => {
  ...
  return (
    <StyledInput>
      <h1>Enter Data</h1>
      <p>Some of the algorithm required to have equal length.</p>
      <Form onSubmit={handleSubmit}>
        <fieldset>
          <label htmlFor="react-select-algo">Select Process Algorithm</label>
          <AlgoSelect
        ...
        <fieldset>
          <label htmlFor="arrival-time">AT - Arrival Times</label>
          <input
        ...
        <fieldset>
          <label htmlFor="burst-time">BT - Burst Times</label>
          <input
        ...
        {selectedAlgo.value === 'RR' && (
          <fieldset>
            <label htmlFor="time-quantum">QT - Quantum Time</label>
            <input
