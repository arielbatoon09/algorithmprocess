...
const Table = ({ solvedProcessesInfo }: TableProps) => {
  ...
  const totalCT = total(completionTime);
      ...
      <StyledTable>
        <thead>
          <tr>
            ...
            <HeaderCell>BT</HeaderCell>
            <HeaderCell>CT</HeaderCell>
            <HeaderCell>TAT</HeaderCell>
            <HeaderCell>WT</HeaderCell>
          </tr>
        </thead>
        <tbody>
