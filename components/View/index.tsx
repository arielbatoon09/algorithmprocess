...
import { OptionType } from '../Controller/AlgoSelect';
  ...
  if (!arrivalTime.length || !burstTime.length) {
    return (
      <StyledOutput>
        ...
        <Text>Enter data to show the Gantt Chart and Table.</Text>
        <hr></hr>
        <Text><li>AT - Arrival Time</li></Text>
        <Text><li>BT - Burst Time</li></Text>
        <Text><li>CT - Completion Time</li></Text>
        <Text><li>TAT - Turn Around Time</li></Text>
        <Text><li>WT - Waiting Time</li></Text>
        <Text><li>RT - Return Time</li></Text>
      </StyledOutput>
    );
  } else {
